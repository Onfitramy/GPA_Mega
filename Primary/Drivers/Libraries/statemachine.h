...
#define MIN_DELAY_UNTIL_BURNOUT_DETECTED    3500
#define MIN_DELAY_UNTIL_DROGUE_COMMANDED    9000
#define MIN_DELAY_UNTIL_DROGUE_CONFIRMED    0
...
#define MAX_DELAY_UNTIL_BURNOUT_DETECTED    5500
#define MAX_DELAY_UNTIL_DROGUE_COMMANDED    13000
#define MAX_DELAY_UNTIL_TOUCHDOWN_BAD       20000   // *!*
#define MAX_DELAY_UNTIL_MAIN_COMMANDED      150000
#define MAX_DELAY_UNTIL_TOUCHDOWN_DROGUE    60000
#define MAX_DELAY_UNTIL_TOUCHDOWN_MAIN      120000
...
typedef struct {
    ...
    uint32_t timestamp_ms;              // Holds time of entering current state
} StateMachine_t;
