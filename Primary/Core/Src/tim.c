...
void MX_TIM2_Init(void)
{
  ...
  {
    Error_Handler();
  }*/ // Channel 3 Pin is used as a CS for SPI
...
/* TIM5 init function */
/*This timer is for the microsecond measuring*/
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = GPIO11_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(GPIO11_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = RGB1_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(RGB1_PWM_GPIO_Port, &GPIO_InitStruct);
