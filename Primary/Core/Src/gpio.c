...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, IMU1_CS_Pin|GPIO14_Pin|GNSS_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MAG_CS_Pin|PYRO1_Pin|PYRO2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO11_Pin|GPIO12_Pin|GPIO13_Pin|EXT2_CS_Pin
                          |M1_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, IMU2_CS_Pin|EXT1_CS_Pin|NRF_CE_Pin|NRF_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : IMU1_CS_Pin GPIO14_Pin GNSS_RST_Pin */
  GPIO_InitStruct.Pin = IMU1_CS_Pin|GPIO14_Pin|GNSS_RST_Pin;
  ...
  /*Configure GPIO pin : F4_INT_Pin */
  GPIO_InitStruct.Pin = F4_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(F4_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO11_Pin GPIO12_Pin GPIO13_Pin EXT2_CS_Pin
                           M1_LED_Pin */
  GPIO_InitStruct.Pin = GPIO11_Pin|GPIO12_Pin|GPIO13_Pin|EXT2_CS_Pin
                          |M1_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : GNSS_INT_Pin GNSS_TP_Pin GNSS_TX_RDY_Pin MAG_INT_Pin */
  GPIO_InitStruct.Pin = GNSS_INT_Pin|GNSS_TP_Pin|GNSS_TX_RDY_Pin|MAG_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
