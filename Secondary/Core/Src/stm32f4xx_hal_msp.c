...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = NTC1_Pin|NTC_BAT_Pin;
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA3     ------> ADC2_IN3
    */
    GPIO_InitStruct.Pin = VD1_Pin|VD2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, NTC1_Pin|NTC_BAT_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA3     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, VD1_Pin|VD2_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = RGB2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(RGB2_PWM_GPIO_Port, &GPIO_InitStruct);
